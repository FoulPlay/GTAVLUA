...
local RndModels = true -- true for random models else false for single model.
--local RndWeapons = true -- true for random weapons else false for single weapon. FIXING IT!
...
function bodyguardScript.GetRndModel()
	...
	if (RndMod_1 == RndMod_2) then
		return RndModels_table[math.random(#RndModels_table)]
	elseif (not RndMod_1 == RndMod_2) then
